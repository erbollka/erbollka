# Retail Report AI architecture

## Цель

Retail Report AI проверяет Excel-отчеты розничных магазинов: продажи, зарплаты, премии, остатки, расходы, итоги и подозрительные отклонения. Детерминированные проверки выполняются кодом, а AI объясняет уже найденные факты простым языком и предлагает исправления.
