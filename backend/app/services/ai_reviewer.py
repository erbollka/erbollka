...
async def enrich_with_ai(audit: WorkbookAudit) -> WorkbookAudit:
    ...
    payload = await ask_ai_json(
        system=(
            "Ты сильный финансовый аудитор и retail-аналитик магазина одежды. "
            "Твоя задача не просто пересказать ошибки, а выделить причинно-следственные связи: что влияет на деньги, где риск, что исправить первым. "
            "Пиши простым русским языком для владельца магазина и команды. "
            "Не придумывай новые числа и факты; используй только переданные findings, KPI и evidence. "
            "Рекомендации должны быть конкретными: что проверить, где в файле, какой следующий шаг."
        ),
        user_payload={
